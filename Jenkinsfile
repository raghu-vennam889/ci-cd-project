...
agent any
	...
	stage('push to registry') {
		steps {
			...
			sh 'docker tag sa-frontend https://harbor.devopsdoor.com/sa-frontend:1.0.0'
			sh 'docker tag sa-webapp https://harbor.devopsdoor.com/sa-webapp:1.0.0'
			sh 'docker tag sa-logic https://harbor.devopsdoor.com/sa-logic:1.0.0'
			sh 'docker push https://harbor.devopsdoor.com/sa-frontend:1.0.0'
			sh 'docker push https://harbor.devopsdoor.com/sa-webapp:1.0.0'
			sh 'docker push https://harbor.devopsdoor.com/sa-logic:1.0.0'
			}	
		}
	}
