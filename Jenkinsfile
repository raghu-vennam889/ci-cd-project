...
agent any
	...
	stage('push to registry') {
		steps {
			...
			sh 'docker tag sa-frontend 54.205.127.4/cicd_dev/sa-frontend:1.0.0'
			sh 'docker tag sa-webapp 54.205.127.4/cicd_dev/sa-webapp:1.0.0'
			sh 'docker tag sa-logic 54.205.127.4/cicd_dev/sa-logic:1.0.0'
			sh 'docker push 54.205.127.4/cicd_dev/sa-frontend:1.0.0'
			sh 'docker push 54.205.127.4/cicd_dev/sa-webapp:1.0.0'
			sh 'docker push 54.205.127.4/cicd_dev/sa-logic:1.0.0'
			}	
		}
	}
